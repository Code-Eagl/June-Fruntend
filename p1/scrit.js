...
let horror = document.querySelector("#horrer");
let drama = document.querySelector("#drama");
let sci_fi = document.querySelector("#sci_fi");

//fetching data from array stored in array movie
let showdata = (movies) => {
...
action.addEventListener("click", () => {
  console.log("clicked");
  let newmovie = movies.filter((movies) => movies.category === "Action");
  showdata(newmovie);
});

thriller.addEventListener("click", () => {
  console.log("clicked");
  let newmovie = movies.filter((movies) => movies.category === "Thriller");
  showdata(newmovie);
});

animation.addEventListener("click", () => {
  console.log("clicked");
  let newmovie = movies.filter((movies) => movies.category === "Animation");
  showdata(newmovie);
});

horror.addEventListener("click", () => {
  console.log("clicked");
  let newmovie = movies.filter((movies) => movies.category === "Horror");
  showdata(newmovie);
});

drama.addEventListener("click", () => {
  console.log("clicked");
  let newmovie = movies.filter((movies) => movies.category === "Drama");
  showdata(newmovie);
});

sci_fi.addEventListener("click", () => {
  console.log("clicked");
  let newmovie = movies.filter((movies) => movies.category === "Sci_Fi");
  showdata(newmovie);
});
